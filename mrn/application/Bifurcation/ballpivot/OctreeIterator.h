 ...
 */
    ...
    public : //accessors modifiers
         ...
         * @return false if the radius was not coherent with
         * the structure (> bounding box size)
         */
        ...
        /** @brief set depth and radius accordingly (smallest 
         * radius for this depth)
    ...
    public : //getting neighbors
        ...
        /** @brief get star neighbors of a given point when the
         * node containing that point   is known
         * @param query query point
        ...
        /** @brief get neighbors of a given point when the node containing that
         * point is known neighbors are sorted by their distances to
         * the query
         * @param query query point
         ...
         * @param exceptions set of elements that are allowed in
         * the neighborhood
    ...
    private :
        ...
        /**
         *  @brief explore a node to look at neighbors of a point. Stops
         * if one of those neighbors is not in the exception set
         * @param node (node to explore)
         * @param query_point (center of the neighborhood)
        ...
        /** @brief explore a node to find neighbors of a point and sort 
         * them according to their distances
         * @param node (node to explore)
         * @param query_point (center of the neighborhood)
         * @param neighbors map of points sorted by their distances to
         * the query point 
         */
         ...
         * (at the end is is the end of path node)
        ...
        /**
         * @brief compute the code of a given position (useful for locating
         * points and traversing the octree
